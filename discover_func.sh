...
#
# file - discover_func.sh
# This script has a feature that discover function of special string.
#
# Author: lssnow
# Date: 2017.07.21
#
# Usage:
# discover_func.sh <FILENAME> <STRING>
#
#

function func_usage {
    echo "Usage:"
    echo "discover_func.sh <FILENAME> <STRING>"
    ...
    echo " "
    echo "Example:"
    echo "discover_func.sh poe_ioctl.c POE_FUNC_RENAME"
    echo " "
    exit 1
}
...
do
    echo "$func"
    sed -i 's/'$2'('$func')/'$func'/g' `find . -name $1`
done
